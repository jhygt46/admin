...
class Admin{
    ...
    public function mostrar_js(){
        ...
        if($sitio == "_mika_sushi"){
            $categorias = $this->con->sql("SELECT id_cat as id, nombre, precio, envoltura as listenv, sub_txt FROM _mika_categorias WHERE eliminado='0' AND id_page='2' ORDER BY orders");
