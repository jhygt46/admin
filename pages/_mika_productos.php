...
if(isset($_GET["id"]) && is_numeric($_GET["id"]) && $_GET["id"] != 0){
    ...
    $ids = $_GET["id"];
    $mm = $admin->con->sql("SELECT * FROM _mika_productos WHERE id_page='".$_SESSION['user']['info']['id_page']."' AND id_cat='".$ids."' AND eliminado='0'");
    $list = $mm['resultado'];
    $id_pro = 0;
            ...
            <ul class='listUser'>
                ...
                <li class="user" rel="<?php echo $id; ?>">
                    <ul class="clearfix">
                        ...
                        <a title="Modificar" class="icn modificar" onclick="navlink('<?php echo $page_mod; ?>?id=<?php echo $ids; ?>&id_pro=<?php echo $id; ?>')"></a>
                    </ul>
                </li>
